...
public class VideosApi {
    ...
    /**
     * Build call for getVideoStatusById
     * @param videoId Id of the video (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    public okhttp3.Call getVideoStatusByIdCall(String videoId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getVideoStatusByIdValidateBeforeCall(String videoId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'videoId' is set
        if (videoId == null) {
            throw new ApiException("Missing the required parameter 'videoId' when calling getVideoStatusById(Async)");
        }

        return getVideoStatusByIdCall(videoId, _callback);
     ...
     */
    public VideoStatus getVideoStatusById(String videoId) throws ApiException {
        ApiResponse<VideoStatus> localVarResp = getVideoStatusByIdWithHttpInfo(videoId);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<VideoStatus> getVideoStatusByIdWithHttpInfo(String videoId) throws ApiException {
        okhttp3.Call localVarCall = getVideoStatusByIdValidateBeforeCall(videoId, null);
        Type localVarReturnType = new TypeToken<VideoStatus>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Retun the detailed status of the video (asynchronously)
     * 
     * @param videoId Id of the video (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call getVideoStatusByIdAsync(String videoId, final ApiCallback<VideoStatus> _callback) throws ApiException {

        okhttp3.Call localVarCall = getVideoStatusByIdValidateBeforeCall(videoId, _callback);
        Type localVarReturnType = new TypeToken<VideoStatus>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
